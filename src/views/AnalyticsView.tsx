    ...
    <div className="h-full flex flex-col overflow-y-auto bg-slate-950 p-6 space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 pb-4 border-b border-slate-800/80">
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-xl font-bold text-white tracking-tight">Productivity Analytics & Historical Audit</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2">
          ...
          <div className="text-[11px] text-slate-400">
            {completedTasks} completed out of {totalTasks} tracked deliverables
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2">
          ...
          <div className="text-2xl font-bold text-indigo-400">{totalFocusHours}h</div>
          <div className="text-[11px] text-slate-400">
            Across {appState.focusSessions.length} completed Pomodoro intervals
          </div>
        </div>
        ...
        <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2">
          ...
          <div className="text-2xl font-bold text-cyan-400">{deepWorkPct}% / {meetingPct}%</div>
          <div className="text-[11px] text-slate-400">
        ...
        <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2">
          ...
          <div className="text-lg font-bold text-emerald-400 mt-1">{burnoutScore}</div>
          <div className="text-[11px] text-slate-400">
      ...
      <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-800 space-y-3">
        <div className="flex items-center justify-between pb-2 border-b border-slate-800">
          ...
          <span className="text-[10px] font-mono text-emerald-400">IndexedDB Audit Log Active</span>
        </div>
            ...
            <div key={log.id} className="pt-2 flex items-start justify-between gap-4 text-xs">
              <div className="space-y-0.5">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-[10px] font-mono text-slate-400 capitalize">[{log.entityType}]</span>
                </div>
